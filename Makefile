#### Civilization 4 SDK Makefile 0.8 ####
####  Copyright 2010 Danny Daemonic  ####
#########################################

# Note: this makefile is designed to work with the setup as described here:
# http://modiki.civfanatics.com/index.php/How_to_Install_the_SDK
# Specifically; using Visual Studio (>= 2008) and the VC++ Toolkit 2003
# -- TC01
...
!IFDEF FD
!IF [IF NOT EXIST $(FD) ECHO. && \
     ECHO "fastdep.exe" NOT FOUND! && \
